...
// Header import is removed (now handled by MainLayout)
...
const AllInterviewsPage = () => {
  ...
  const fetchInterviews = async () => {
    try {
      const data = await fetchUserInterviews(); // Use the correct function name
  ...
  // The outer <div> and <Header> are removed, as MainLayout handles them.
  return (
                ...
                {interviews.map((interview) => (
                  <tr key={interview.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      {/* Using line-clamp-1 requires the @tailwindcss/line-clamp plugin */}
                      <div className="text-sm text-gray-500 truncate">{interview.jobDescription}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {interview.duration} {/* "minutes" text removed */}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
